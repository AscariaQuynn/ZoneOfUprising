 ...
 */
public class DarkFighter6WingGun implements GunBuilder {

    final public String path = "Models/Guns/dark_fighter_6_wing_gun/scene_dark_fighter_6_wing_gun.j3o";
    ...
    final public float rotationSpeed = 0.8f;
    final public Vector4f rotationLimits = new Vector4f(45f, 45f, 45f, 45f);
    ...
    public DarkFighter6WingGun(ProjectileBuilder projectileBuilder) {
