 ...
 */
public class LimitLinesInDocument implements DocumentListener
{
         ...
         */
        public LimitLinesInDocument(int maximumLines)
        {
         ...
         */
        public LimitLinesInDocument(int maximumLines, boolean isRemoveFromStart)
        {
