...
public class ConsoleRedirect
{
	...
	public ConsoleRedirect(JTextComponent textComponent)
	{
	 ...
	 */
	public ConsoleRedirect(JTextComponent textComponent, boolean isAppend)
	{
	...
	public void setMessageLines(int lines)
	{
		...
		limitLinesListener = new LimitLinesInDocument(lines, isAppend);
